  ...
  return (
    <Fragment>
      <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark slide-in-left">
        <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 text-white min-vh-100 slide-in-left-sticky">
          <Link
            to="/"
            className="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none"
          >
            <span className="fs-5 d-none d-sm-inline ff-jost fw-600 sidebarName">
              Nilima Javade
            </span>
          </Link>
          <ul
          ...
          >
            ...
            <li className="nav-item">
              <NavLink
                ...
                className="nav-link align-middle px-0 text-white"
              >
                <AiOutlineMobile className="fs-5" />{" "}
          ...
          <div className="dropdown pb-4 dropup">
            ...
            >
              ...
              <li>
                ...
                >
                  <VscAccount className="fs-5" /> Mobile No.
                </a>
              </li>
            </ul>
          </div> */}
